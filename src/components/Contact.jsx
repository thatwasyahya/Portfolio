...
const Contact = () => {
    ...
    const serviceID = 'service_lzw410i';
    const templateID = 'template_vm9zi2c';
    const publicKey = '5SEsZyMhKfyoRHlQM';
    const toName = 'to_name';
    const toEmail = 'yahyacoubi64@gmail.com'; // Set this to your email address
